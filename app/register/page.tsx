          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-transparent text-white/70">або</span>
              </div>
            </div>
            ...
            <button
              ...
              className="group relative flex w-full justify-center items-center gap-3 rounded-xl border border-white/30 bg-white/20 backdrop-blur-sm px-4 py-3 text-sm font-semibold text-white hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-offset-2 focus:ring-offset-transparent transition-all duration-200 shadow-lg"
            >
